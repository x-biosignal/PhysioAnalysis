...
- [`specparam()`](https://x-biosignal.github.io/PhysioAnalysis/reference/specparam.md)
  [`print(`*`<specparam_result>`*`)`](https://x-biosignal.github.io/PhysioAnalysis/reference/specparam.md)
...
- [`tukeyHSD()`](https://x-biosignal.github.io/PhysioAnalysis/reference/tukeyHSD.md)
  : Tukey HSD post-hoc test (all pairwise comparisons after one-way
  ANOVA)
